...
MODEL_OUT_DIR = os.path.normpath(os.path.join(BASE_DIR, "..", "..", "trained_models", "ensemble_bc"))
...
if __name__ == "__main__":
    ...
    for fruit in FRUITS:
        ...
        print(f"\nBuilding feature dataset for {fruit} (B: shape + C: texture)...")
        ...
        # SVM-improvement backlog item #1: class_weight='balanced' re-weights
        # the loss inversely proportional to class frequency, targeting the
        # persistently weak mango-rotten recall (0.03-0.16 across all 4
        # members in the training logs) without touching the dataset itself.
        ...
        out_path = os.path.join(MODEL_OUT_DIR, f"{fruit}_ensemble_bc.pkl")
    ...
    if accuracies:
        ...
        print(f"\nAll graphs saved to outputs/training/bc/")
