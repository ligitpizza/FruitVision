...
from m14v2_train_report import (
...
MODEL_OUT_DIR = os.path.normpath(os.path.join(BASE_DIR, "..", "..", "trained_models", "m14v2"))
...
if __name__ == "__main__":
    ...
    for fruit in FRUITS:
        ...
        print(f"\nBuilding feature dataset for {fruit} (m14v2: A colour + B shape + D gabor + C texture)...")
        ...
        # class_weight='balanced' -- see member_apps/member_1_ab/m1_train.py
        # for the full rationale (targets mango-rotten recall).
        ...
        out_path = os.path.join(MODEL_OUT_DIR, f"{fruit}_m14v2.pkl")
    ...
    if accuracies:
        ...
        print(f"\nAll graphs saved to outputs/training/m14v2/")
