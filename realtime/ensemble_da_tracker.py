...
from member_apps.member_4_da.m4_preprocessing import clean
from member_apps.member_4_da.m4_detection import detect as classical_detect
...
def _classify_crop(crop, fruit_type):
    ...
    try:
        label, confidence, _bbox, _cleaned, _proba = m4_predict_ripeness(crop, fruit_type)
